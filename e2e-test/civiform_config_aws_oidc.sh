...
# Needs to be a version from https://github.com/civiform/civiform/releases, "v1.8.2" for example.
...
export BASE_URL="https://civiform-deploy-e2e-tests.civiform.dev"
...
export STAGING_HOSTNAME="civiform-deploy-e2e-tests.civiform.dev"
...
export APP_PREFIX="e2e-test" # max 19 chars, only numbers, letters, dashes, and underscores
