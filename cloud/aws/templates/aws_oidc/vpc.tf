...
locals {
  ...
  vpc_private_subnet_ids         = local.enable_managed_vpc ? module.vpc[0].private_subnets : data.aws_subnets.external_private_subnet_ids
  vpc_public_subnet_ids          = local.enable_managed_vpc ? module.vpc[0].public_subnets : data.aws_subnets.external_public_subnet_ids
