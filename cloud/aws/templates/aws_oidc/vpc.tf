...
locals {
  ...
  vpc_private_subnet_ids         = local.enable_managed_vpc ? module.vpc[0].private_subnets : var.external_private_subnet_ids
  vpc_public_subnet_ids          = local.enable_managed_vpc ? module.vpc[0].public_subnets : var.external_public_subnet_ids
