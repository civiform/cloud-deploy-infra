locals {
  ...
  app_settings = merge({
    ...
    DB_JDBC_STRING       = "jdbc:postgresql://${azurerm_postgresql_flexible_server.civiform.name}.postgres.database.azure.com:5432/postgres?user=${locals.DB_USERNAME}&password=${locals.DB_PASSWORD}&sslmode=require"
